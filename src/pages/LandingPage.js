  ...
  useEffect(() => {
    if (movies.length > 0) {
      const posterInterval = setInterval(() => {
        ...
        setCurrentImageIndex(0); // Reset image index when changing movie
  ...
  const renderMovieSection = () => {
    ...
    return (
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="md:w-1/2 relative h-[80vh]">
          <img
            src={currentImage}
            alt={`${currentMovie.title} ${currentImageIndex === 0 ? 'Poster' : 'Additional Image'}`}
            className="w-full h-full object-contain shadow-lg shadow-[#00000033] rounded-[21px] transition-opacity duration-500"
          />
        </div>
      </div>
    );
        ...
        <section className="py-12 px-4 bg-gray-100">
          <div className="container mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              ...
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 bg-white rounded-[16px] shadow-md p-6 text-center">
                <img src={images.electricScooter} alt="Electric Scooter" className="w-32 h-32 mx-auto mb-4 object-cover rounded-[21px]" />
              ...
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 bg-white rounded-[16px] shadow-md p-6 text-center">
                <img src={images.electricCar} alt="Electric Car" className="w-32 h-32 mx-auto mb-4 object-cover rounded-[21px]" />
