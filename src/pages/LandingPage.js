            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8 flex flex-col items-center md:items-start">
                ...
                <p className="text-xl text-gray-600 mb-6 text-left">
                  Reserve your tickets for the most anticipated Malayalam movie
                  "Turkish Tharkkam" this Onam and win exciting giveaways. Avail
                  the benefits of pre-booking campaign run by Ticketflix.in
              ...
              <div className="md:w-1/2">
                <img
                  ...
                  alt="Movie Poster"
                  className="w-full h-[80vh] shadow-lg shadow-[#00000033] rounded-[21px] transition-opacity duration-500"
                />
              </div>
            </div>
          </div>
        ...
        <section className="py-12 px-4 bg-gray-100">
          <div className="container mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 bg-white rounded-[16px] shadow-md p-6 text-center">
                <img src={images.iPhone} alt="iPhone" className="w-32 h-32 mx-auto mb-4 object-cover rounded-[21px]" />
              ...
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 bg-white rounded-[16px] shadow-md p-6 text-center">
                <img src={images.electricScooter} alt="Electric Scooter" className="w-[12em] h-32 mx-auto mb-4 object-cover rounded-[21px]" />
              ...
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 bg-white rounded-[16px] shadow-md p-6 text-center">
                <img src={images.electricCar} alt="Electric Car" className="w-[12em] h-32 mx-auto mb-4 object-cover rounded-[21px]" />
