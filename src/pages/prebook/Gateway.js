...
function PaymentGateway() {
    ...
    const deviceOS = browser ? (browser.os === 'iOS' ? 'IOS' : 'ANDROID') : 'ANDROID';
    ...
    const makePayment = async (e) => {
        ...
        const fullURL = dataBase64 + "/pg/v1/pay" + process.env.REACT_APP_PHONEPE_SALT_KEY;
        const dataSha256 = sha256(fullURL);
        const checksum = dataSha256 + "###" + process.env.REACT_APP_PHONEPE_SALT_INDEX;
        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-yellow-100 to-yellow-300">
            ...
            <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
                <div className="w-full max-w-md bg-white shadow-2xl rounded-lg px-8 pt-6 pb-8 mb-4">
                    <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Confirm Payment</h2>
                    <div className="space-y-4 mb-6">
                        <p><strong>Amount:</strong> ₹{paymentData.amount}</p>
                        <p><strong>Mobile:</strong> {paymentData.mobileNumber}</p>
