...
function PrebookingForm() {
    ...
    const fetchMovieAndTheatres = async () => {
      try {
        ...
        if (movieSnap.exists()) {
          ...
          const theatrePromises = movie.theatreIds.map((id) =>
            getDoc(doc(db, "theatres", id))
          );
          ...
          const uniqueLocations = [
            ...new Set(theatreData.map((theatre) => theatre.district)),
          ];
  ...
  useEffect(() => {
    if (formData.location) {
      const filtered = theatres.filter(
        (theatre) => theatre.district === formData.location
      );
  ...
  // const validateForm = () => { // FIXME: Unused
  //   const newErrors = {};
  ...
  const getAvailableTheatres = (preference) => {
    return filteredTheatres.filter((theatre) => {
      ...
      if (preference === "secondPreference")
        return theatre.id !== formData.firstPreference;
      if (preference === "thirdPreference")
        return (
          theatre.id !== formData.firstPreference &&
          theatre.id !== formData.secondPreference
        );
      return false;
    });
  };
    ...
    try {
      ...
      if (movieSnap.exists()) {
        ...
        const updatePreferenceMap = (preferenceField, theatreId) => {
          ...
          const newCount =
            (currentMap[theatreId] || 0) + formData.numberOfSeats;
          return { ...currentMap, [theatreId]: newCount };
        };

        if (formData.firstPreference) {
          updatedPreferences.firstPreference = updatePreferenceMap(
            "firstPreference",
            formData.firstPreference
          );
        }
        if (formData.secondPreference) {
          updatedPreferences.secondPreference = updatePreferenceMap(
            "secondPreference",
            formData.secondPreference
          );
        }
        if (formData.thirdPreference) {
          updatedPreferences.thirdPreference = updatePreferenceMap(
            "thirdPreference",
      ...
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="w-full max-w-md">
          <form
            ...
            className="bg-white shadow-2xl rounded-lg px-8 pt-6 pb-8 mb-4 space-y-6"
          >
            ...
            {["name", "phone", "email"].map((field) => (
              <div key={field} className="relative">
                <input
                  ...
                  className={`peer w-full px-3 py-2 border-b-2 ${
                ...
                <label
                  htmlFor={field}
                  className={`absolute left-3 -top-3.5 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-sm ${
            ...
            <div className="relative">
              ...
              <select
                ...
                } bg-white py-2 px-3 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              >
            ...
            <div className="relative">
              ...
              <select
                ...
                onChange={handleChange}
                className={`mt-1 block w-full border ${
                  errors.firstPreference ? "border-red-500" : "border-gray-300"
                } bg-white py-2 px-3 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              >
            ...
            <div className="relative">
              ...
              <select
                ...
                onChange={handleChange}
                className={`mt-1 block w-full border ${
                  errors.secondPreference ? "border-red-500" : "border-gray-300"
                } bg-white py-2 px-3 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              >
            ...
            <div className="relative">
              ...
              <select
                ...
                onChange={handleChange}
                className={`mt-1 block w-full border ${
                  errors.thirdPreference ? "border-red-500" : "border-gray-300"
                } bg-white py-2 px-3 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                } py-2 px-3 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
                min="1"
                max="10"
                required
              />
            ...
            <div className="flex items-center mb-4">
              <input
                ...
                onChange={handleChange}
                className="h-4 w-4 stroke-black border-gray-300 rounded"
                required
              />
              <label
                htmlFor="agreeTerms"
            ...
            <button
              type="submit"
              className={`w-full py-3 px-4 font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-red-700 focus:ring-opacity-75 transition-colors ${
                agreedToTerms
                  ? "bg-red-800 text-white hover:bg-yellow-700"
